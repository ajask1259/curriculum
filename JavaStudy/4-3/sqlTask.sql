...
-- [回答]
SELECT goods_table.goods_name,store_table.store_name,stock_table.quantity 
FROM stock_table 
JOIN goods_table 
ON goods_table.goods_code = stock_table.goods_code 
JOIN store_table 
