...
public class DBUpdate {
    ...
    private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/sql課題";
    /** ・ユーザー名 */
    // 問② データベースのユーザー名を定数にしなさい。
    private static final String USER = "postgres";
    /** ・パスワード */
    // 問③ データベースのパスワードを定数にしなさい。
    private static final String PASS = "7843uire";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String SQL ="UPDATE tb_shohin SET SHOHIN_NAME = '商品20',tanka = 800 where shohin_id = '020'";
